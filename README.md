...
| :---          |   ---:    |  ---:        |
| Участник №1   | 50        |  босс        |
| Участник №2   | 30        |  патрошитель памяти |
| Участник №3   | 20        |  самозванец  |
...
_Подробно описываете формат хранения (JSON, XML, CSV, YAML и пр.) и процесс генерации тестовых данных._

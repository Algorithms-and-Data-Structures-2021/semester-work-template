...
**добавлению** элементов в структуру данных. Название папки `01`, ..., `10` обозначает номер набора данных. Названия файлов `100.csv`. `1000.csv` и т.д. хранят информацию о размере набора данных (т.е. количестве элементов). 
